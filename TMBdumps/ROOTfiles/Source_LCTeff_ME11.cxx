...
TCanvas* c1 = new TCanvas("c1","Average LCT Efficiency vs. Source Intensity (1/Att.)", 1200, 1200);
c1->SetFillColor(kYellow-6);
c1->SetGrid();

Float_t xmin = 0, xmax = 0.05; 
Float_t ymin = 0.975, ymax = 1;

TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"LCT Efficiency vs. Source Intensity   (ME1/1, equalized gain HV0)");
hr->SetXTitle("Source Intensity (1/Att.)");
...
c1->GetFrame()->SetFillColor(kYellow-9);
c1->GetFrame()->SetBorderSize(12);

TGraphErrors* g1 = new TGraphErrors("./LCTvsSourceME11.txt","%lg %lg %lg");
TGraphErrors* g2 = new TGraphErrors("./LCTvsSourceME21.txt","%lg %lg %lg");

g1->SetMarkerColor(kViolet);
g1->SetMarkerStyle(kOpenCircle);
g1->SetLineColor(kViolet+9);
g1->Draw("LP");
