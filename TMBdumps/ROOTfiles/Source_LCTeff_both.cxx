...
void Source_LCTeff_both(){

TCanvas* c1 = new TCanvas("c1","Average LCT Efficiency vs. Source Intensity (1/Att.)", 1200, 1600);
c1->SetFillColor(kGray);
c1->SetGrid();

Float_t xmin = 0, xmax = 25; 
Float_t ymin = 0.93, ymax = 1;

TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"LCT Efficiency vs. Current");
hr->SetXTitle("Average Current Per Layer (#muA)");
hr->SetYTitle("Average LCT Efficiency");
...
TGraphErrors* g1 = new TGraphErrors("./LCT_vs_currentME11.txt","%lg %lg %lg");
TGraphErrors* g2 = new TGraphErrors("./LCT_vs_currentME21.txt","%lg %lg %lg");
...
g2->SetMarkerColor(kAzure+9);
g2->SetMarkerStyle(21);
g2->SetLineColor(kAzure+9);
g2->SetLineWidth(2);
g2->Draw("LP");
...
leg->AddEntry(g1,"ME1/1 at eqHV0 Settings","lep");
leg->AddEntry(g2,"ME2/1 at eqHV0 Settings","lep");
