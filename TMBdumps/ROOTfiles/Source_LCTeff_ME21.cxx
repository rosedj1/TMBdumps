...
Float_t ymin = 0.9, ymax = 1;

TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"LCT Efficiency vs. Source Intensity   (ME2/1, equalized gain HV0)");
...
TGraphErrors* g1 = new TGraphErrors("./LCTvsSourceME21.txt","%lg %lg %lg");
