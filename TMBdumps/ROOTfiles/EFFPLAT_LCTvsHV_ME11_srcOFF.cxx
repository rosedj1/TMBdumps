...
void EFFPLAT_LCTvsHV_ME11_srcOFF(){
...
TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"EFF PLATEAU: Average LCT Efficiency of ME1/1, srcOFF");
hr->SetXTitle("HV [V]");
