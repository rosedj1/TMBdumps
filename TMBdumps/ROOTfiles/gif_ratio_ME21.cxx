...
c1->SetFillColor(kAzure+2);
c1->SetGrid();

int xmin = 3260, xmax = 3810; 
Float_t ymin = 0.2, ymax = 0.25, HV0 = 3601.9444;

TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"Scintillator Trigger Ratio during Test40, ME2/1, srcOFF");
hr->SetXTitle("HV [V]");
...
c1->GetFrame()->SetFillColor(kAzure+5);
c1->GetFrame()->SetBorderSize(12);

TGraphErrors* g1 = new TGraphErrors("./beam_stab_ME21_srcOFF_T40.txt","%lg %lg %lg");
...
g1->SetMarkerColor(kOrange+4);
g1->SetMarkerStyle(kOpenCircle);
g1->SetLineColor(kOrange+4);
g1->Draw("LP");
...
leg->AddEntry(line,"equalized gain, average HV0 = 3601.9 V","l");
leg->SetFillColor(kOrange+2);
leg->Draw("same");
