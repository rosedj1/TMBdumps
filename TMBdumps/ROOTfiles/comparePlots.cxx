...
Float_t ymin = 0, ymax = 1, HV0 = 3601.9444;

TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"TMB and DAQ Efficiencies of ME2/1, srcOFF, USING TB1 DATA");
hr->SetXTitle("HV [V]");
...
TGraphErrors* g1 = new TGraphErrors("./TB1_ME21_Jakes.txt","%lg %lg %lg");
...
leg->AddEntry(g1,"TMB Based LCT Efficiency","lep");
