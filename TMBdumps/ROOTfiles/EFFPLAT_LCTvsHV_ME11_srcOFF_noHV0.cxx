...
void EFFPLAT_LCTvsHV_ME11_srcOFF_noHV0(){

TCanvas* c1 = new TCanvas("c1","ME1/1 LCT efficiency", 1600, 1200);
c1->SetFillColor(kGray);
c1->SetGrid();

int xmin = 2725, xmax = 3020; 
Float_t ymin = 0.97, ymax = 1.01, HV0 = 2869.1667;

TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"EFF PLATEAU: Average LCT Efficiency of ME1/1 (no HV0), srcOFF");
hr->SetXTitle("HV [V]");
...
TGraphErrors* g1 = new TGraphErrors("./ME11_srcOFF_noHV0.txt","%lg %lg %lg");
...
g1->Fit("pol1","","",2775,3010);
g1->GetFunction("pol1")->SetLineColor(kBlue);
g1->GetFunction("pol1")->SetLineWidth(1);
gStyle->SetOptFit(1);
gStyle->SetStatX(0.9);
gStyle->SetStatY(0.9);
//gPad->Update();
...
int main()
{
	EFFPLAT_LCTvsHV_ME11_srcOFF_noHV0();
	return 0;
}
#endif
