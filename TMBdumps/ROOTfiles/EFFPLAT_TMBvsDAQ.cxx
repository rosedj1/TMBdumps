...
void EFFPLAT_TMBvsDAQ(){

TCanvas* c1 = new TCanvas("c1","LCT efficiency of ME2/1 ", 1200, 1600);
c1->SetFillColor(kGray);
c1->SetGrid();

int xmin = 3280, xmax = 3820; 
Float_t ymin = -0.03, ymax = 0.03, HV0 = 3601.9444;

TH1F* hr = c1->DrawFrame(xmin,ymin,xmax,ymax,"TMB and DAQ Efficiency Difference, ME2/1, srcOFF, USING TB1 DATA");
hr->SetXTitle("HV [V]");
hr->SetYTitle("TMB Eff. - DAQ Eff. (meas. in %)");
//gPad->GetTickx();
...
TGraphErrors* g1 = new TGraphErrors("./TMB_vs_DAQ_percent.txt","%lg %lg %lg");
//TGraphErrors* g2 = new TGraphErrors("./TB1_ME21_Bhargavs.txt","%lg %lg %lg");
...
//leg->AddEntry(g1,"","lep");
//leg->AddEntry(g2,"DAQ Based LCT Efficiency","lep");
leg->AddEntry(line,"Equalized gas gain for each layer","l");
leg->AddEntry(line,"(average HV0 = 3601.9 V)","");
leg->Draw("same");
