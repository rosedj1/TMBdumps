...
echo "Name the directory to be created. This will store all files created by this process."
read Name

echo ; echo "Automagicize entire process? (y or n)"
read ans_all ; echo
if [ $ans_all = 'y' ] 
then 
	ans_measlist='y'
